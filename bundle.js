...
/***/ function(module, exports, __webpack_require__) {
	...
	/* WEBPACK VAR INJECTION */(function(riot) {riot.tag2('app', '<header> <div> <h1>Flex Maid</h1> <span> At your service </span> </div> </header> <input name="name" type="text"> <div each="{breakpoint in breakpoints}"> <breakpoint label="{breakpoint.label}" pixel="{breakpoint.pixel}"></breakpoint> </div>', '', '', function(opts) {
	        this.breakpoints = [
	            {
	                label: 'sm',
	                pixel: 500
...
/***/ function(module, exports, __webpack_require__) {
	...
	// imports
	exports.push([module.id, "@import url(https://fonts.googleapis.com/css?family=Montez);", ""]);
