...
/***/ function(module, exports, __webpack_require__) {
	...
	/* WEBPACK VAR INJECTION */(function(riot) {riot.tag2('app', '<header> <div layout layout-align="start start"> <img width="175" src="img/flexmaid.png" alt=""> <div> <h1>Flex Maid</h1> <span> At your service </span> </div> </div> </header> <section> <div> <input type="text" name="label"> <div class="slider" name="pixelSlider"></div> <input type="submit" onclick="{add}" name="name" value="subimt"> </div> </section> <section class="breakpoints"> <breakpoint each="{breakpoint, index in breakpoints}" layout="row" layout-align="space-between" riot-style="background-color: hsl(330, 50%, {25+(50/breakpoints.length)*index}%)" label="{breakpoint.label}" pixel="{breakpoint.pixel}"> </breakpoint> </section>', '', '', function(opts) {
	        this.breakpoints = [
	            {
	                label: 'sm',
	                pixel: 500
