...
/***/ function(module, exports, __webpack_require__) {
	...
	var nouislider = rquire('nouislider');

	console.log('REPORT SCOPE requ');
...
/***/ function(module, exports, __webpack_require__) {
	...
	/* WEBPACK VAR INJECTION */(function(riot) {riot.tag2('app', '<header> <div layout layout-align="start start"> <img width="175" src="img/flexmaid.png" alt=""> <div> <h1>Flex Maid</h1> <span> At your service </span> </div> </div> </header> <a class="button reverse">Download</a> a.button <input name="label" type="text"> <input type="submit" onclick="{add}" name="name" value="subimt"> <section class="breakpoints"> <breakpoint each="{breakpoint, index in breakpoints}" layout="row" layout-align="space-between" riot-style="background-color: hsl(330, 50%, {25+(50/breakpoints.length)*index}%)" label="{breakpoint.label}" pixel="{breakpoint.pixel}"> </breakpoint> </section>', '', '', function(opts) {
	        this.breakpoints = [
	            {
	                label: 'sm',
	                pixel: 500
