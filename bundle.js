...
/***/ function(module, exports, __webpack_require__) {
	...
	/* WEBPACK VAR INJECTION */(function(riot) {riot.tag2('breakpoint', '<div layout layout-align="space-between"> <div> <span onclick="{remove}">&times;</span> </div> <div> <span>{opts.label} - {opts.pixel}</span> </div> </div>', '', '', function(opts) {
